class Invoice:
    ...
    def __init__(self, client, total):
        self._client = client                  # both client and total protected by the underscore-data attribute should be protected use underscore _(private attribute use __)
        self._total = total
    ...
    @property                   # property decorator-user the at symbol-it decorates(wraps around) the property we want to work with
